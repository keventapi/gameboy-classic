class CALL_CC_NN:
    ...
    def call_cc_nn_instructions(self):
        instructions = {
            0xC4: lambda: self.execute_call_cc_nn(12),
            0xCC: lambda: self.execute_call_cc_nn(12),
            0xD4: lambda: self.execute_call_cc_nn(12),
            0xDC: lambda: self.execute_call_cc_nn(12)
        }
        return instructions
